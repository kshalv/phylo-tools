...
# Add phylum name to sequence headers in fasta files
...
def pfam_merger(data_path, output_file):
    ...
    if merged_counted == total_counted:
        ...
        return print('sequence counts do not match')
...
#Generate a random list of accession numbers 
...
# uses a list of accession numbers to pull sequences from a fasta file & writes to a new file
...
#writes a metadata file for sequences in pfam format
...
#writes a metadata file from ncbi fasta format
